      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {data.education.length === 0 ? (
          <div className="bg-[#151F2E] border border-[#263449] rounded-2xl p-12 text-center text-[#94A3B8] max-w-2xl">
            <GraduationCap className="w-10 h-10 text-[#94A3B8] mx-auto mb-3 opacity-60" />
            <h3 className="text-base font-bold text-[#F8FAFC] mb-1">Education details will be added soon.</h3>
            <p className="text-xs text-[#94A3B8] leading-relaxed">
              Academic degrees, programs, and coursework milestones will appear here once updated.
            </p>
          </div>
        ) : (
                      ...
                      {edu.score && (
                        <div className="flex flex-wrap items-center gap-2 mb-2.5">
                          <span className="text-xs font-mono font-semibold text-[#10B981] bg-[#10B981]/10 border border-[#10B981]/25 px-2.5 py-0.5 rounded-full inline-flex items-center space-x-1.5">
                            ...
                            <span>{edu.scoreLabel || 'Score'}: {edu.score}</span>
                          </span>
                        </div>
                      )}
