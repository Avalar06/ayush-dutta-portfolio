    ...
    <section id="experience" className="py-20 md:py-28 bg-[#111827] border-b border-[#263449] relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {experiences.length === 0 ? (
          <div className="bg-[#151F2E] border border-[#263449] rounded-2xl p-12 text-center text-[#94A3B8] max-w-2xl">
            <Briefcase className="w-10 h-10 text-[#94A3B8] mx-auto mb-3 opacity-60" />
            <h3 className="text-base font-bold text-[#F8FAFC] mb-1">Experience entries will be added soon.</h3>
            <p className="text-xs text-[#94A3B8] leading-relaxed">
              Professional experience, internships, and training roles will appear here once updated.
            </p>
          </div>
        ) : (
            ...
            <div className="space-y-8">
              {experiences.map((exp, idx) => (
                <motion.div
                  ...
                  transition={{ duration: 0.5, delay: Math.min(idx * 0.06, 0.25) }}
                  ...
                  <div className="bg-[#151F2E] border border-[#263449] hover:border-[#3B82F6]/50 rounded-2xl p-6 sm:p-8 transition-colors shadow-sm">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6 border-b border-[#263449] pb-5">
                      <div>
                        ...
                        <span className="text-[#94A3B8] font-medium text-sm mt-1 flex flex-wrap items-center gap-1.5">
