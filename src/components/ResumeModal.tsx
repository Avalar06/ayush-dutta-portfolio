      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="relative w-full max-w-4xl bg-[#111827] border border-[#263449] rounded-2xl shadow-2xl p-5 sm:p-6 my-auto flex flex-col max-h-[92vh]"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Header */}
            <div className="flex items-start justify-between border-b border-[#263449] pb-4 mb-4">
              <div className="flex items-center space-x-3">
                <div className="p-2.5 bg-[#2563EB]/10 border border-[#2563EB]/30 text-[#3B82F6] rounded-xl">
              ...
              <button
                onClick={onClose}
                className="text-[#94A3B8] hover:text-[#F8FAFC] bg-[#151F2E] hover:bg-[#263449] p-2 rounded-xl transition-colors border border-[#263449]"
                ...
                {publishedResumes.map((resume) => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex items-center space-x-2 py-1.5 px-3 rounded-lg text-xs font-semibold transition-colors ${
                        isSelected
            ...
            {/* Content Area */}
            {!activeResume ? (
              <div className="p-10 text-center bg-[#151F2E] border border-[#263449] rounded-2xl my-4">
                <AlertCircle className="w-10 h-10 text-[#94A3B8] mx-auto mb-3 opacity-60" />
                <h4 className="text-base font-bold text-[#F8FAFC] mb-1">Resume Currently Updating</h4>
                <p className="text-xs text-[#94A3B8] max-w-md mx-auto leading-relaxed">
                  The resume document is currently being updated by the administrator. Please check back shortly or reach out directly.
                </p>
              </div>
            ) : (
              <div className="space-y-3 flex-1 flex flex-col min-h-0">
                ...
                {activeResume.description && (
                  <p className="text-xs text-[#94A3B8] leading-relaxed bg-[#151F2E] px-3.5 py-2 rounded-xl border border-[#263449]/70">
                    {activeResume.description}
                  </p>
                )}

                {/* In-Browser PDF Preview Iframe */}
                <div className="relative w-full flex-1 min-h-[380px] sm:min-h-[460px] md:min-h-[520px] bg-[#0B1220] rounded-xl border border-[#263449] overflow-hidden">
                  {isFrameLoading && (
                  ...
                  {iframeError && (
                    <div className="absolute inset-0 flex flex-col items-center justify-center bg-[#0B1220] z-10 text-[#94A3B8] p-6 text-center">
                      ...
                      <button
                        ...
                        className="inline-flex items-center space-x-1 text-xs text-[#3B82F6] hover:underline"
                      >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-3 pt-4 mt-4 border-t border-[#263449]">
              <div className="text-[11px] text-[#94A3B8] font-mono truncate max-w-[280px]">
                {activeResume?.pdfPath ? (
                  ...
                  <span>Status: Verified Technical Resume</span>
                )}
              </div>
              ...
              <div className="flex items-center space-x-2 w-full sm:w-auto justify-end">
                ...
                {activeResume && (
                  <>
                    <button
                      onClick={() => handleOpenNewTab(activeResume)}
                      className="inline-flex items-center space-x-1.5 bg-[#151F2E] hover:bg-[#263449] text-[#F8FAFC] font-medium px-4 py-2 rounded-xl transition-colors text-xs border border-[#263449]"
                    >
                    ...
                    <motion.button
                      ...
                      className="inline-flex items-center space-x-2 bg-[#2563EB] hover:bg-[#3B82F6] disabled:opacity-50 text-[#F8FAFC] font-semibold px-4 py-2 rounded-xl transition-colors text-xs shadow-sm shadow-[#2563EB]/25"
                    >
                      {isDownloading ? (
                        <>
